...
{
    if (!threatening) {
        UE_LOG(ACFAILog, Warning, TEXT("invalid Threatening Actor -  UACFThreatManagerComponent"));
...
void UACFThreatManagerComponent::RemoveAllThreatenings()
{
    ThreatMap.Empty();
    OnNewMaxThreateningActor.Broadcast(nullptr);
}
