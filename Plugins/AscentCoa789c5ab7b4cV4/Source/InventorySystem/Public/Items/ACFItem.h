...
struct INVENTORYSYSTEM_API FBaseItem : public FFastArraySerializerItem {
...
protected:
	UPROPERTY(SaveGame, BlueprintReadOnly, Meta = (IgnoreForMemberInitializationTest), Category = ACF)
