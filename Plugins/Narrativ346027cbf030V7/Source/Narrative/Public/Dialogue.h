...
struct NARRATIVE_API FDialoguePlayParams
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Params", meta = (editcondition = "bOverride_bFreeMovement"))
	bool bFreeMovement;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Params", meta = (editcondition = "bOverride_bStopMovement"))
	bool bStopMovement;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Params", meta = (editcondition = "bOverride_bUnskippable"))
	bool bUnskippable;
};
