...
void UUA_GrantInventory::ExecuteForContext(const FBaseUpgradeContext& Context)
{
	Execute(Context.InteractingPawn ? static_cast<UObject*>(Context.InteractingPawn) : Context.GetPreferredActionObject());
}
