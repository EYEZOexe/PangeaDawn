...
private:
    APangeaEggActor* SpawnEgg(UPangeaBreedableComponent* Male, UPangeaBreedableComponent* Female, UPangeaCreatureDefinition* CreatureDefinition, const UPangeaBreedingFragment* BreedingFragment);
    static void ApplyFertilityCooldowns(UPangeaBreedableComponent* Male, UPangeaBreedableComponent* Female, const UPangeaBreedingFragment* BreedingFragment);
};
